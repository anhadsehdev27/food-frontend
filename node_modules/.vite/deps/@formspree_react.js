...
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var $ = (e) => K(g({}, "__esModule", { value: !0 }), e);
...
var require_pure$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
...
function P(e) {
	let { children: t } = e, r = (0, import_react_stripe_umd.useElements)();
...
function N(e) {
	...
	return (0, import_react.useEffect)(() => {
		...
		let i = !0;
		return a?.then((l) => {
			i && l && n((p) => (0, import_dist.createClient)({
				...p,
				stripe: l
			}));
		}), () => {
	...
	}, [a]), import_react.createElement(h.Provider, { value: { client: s } }, a ? import_react.createElement(import_react_stripe_umd.Elements, { stripe: a }, import_react.createElement(P, null, t)) : t);
}
function b() {
...
function F(e, t = {}) {
	...
	return async function(p) {
		...
		let c = a?.getElement(import_react_stripe_umd.CardElement), x = i && c ? () => i.createPaymentMethod({
			type: "card",
			card: c,
			billing_details: G(m)
		}) : void 0;
